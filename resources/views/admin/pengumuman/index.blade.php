        ...
        <main class="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900">
            ...
            <div class="px-10">
                <div class="bg-white rounded-lg overflow-auto shadow">
                    ...
                    {{ $pengumuman->status === 'publikasi' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700' }}">
                                ...
                                <td class="px-4 py-3 text-center space-x-1">
                                    @php
                                    $lampiran = $pengumuman->lampiran ? json_decode($pengumuman->lampiran) : [];
                                    @endphp
                                    ...
                                    <button type="button"
                                        @click="() => {
                                            detailData = {
                                                judul: @js($pengumuman->judul),
                                                tanggal: @js(\Carbon\Carbon::parse($pengumuman->tanggal)->format('d M Y')),
                                                isi_pengumuman: @js($pengumuman->isi_pengumuman),
                                    ...
                                    <!-- Delete -->
                                    <button type="button"
                                        @click="showDeleteModal = true; deleteUrl = '{{ route('admin.pengumuman.destroy', $pengumuman->id) }}'"
                                        title="Hapus"
            ...
            <div
                ...
                <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full relative mt-10">
                    ...
                    <div class="p-6 max-h-[90vh] overflow-y-auto">
                        ...
                        <!-- Isi Pengumuman -->
                        <div class="text-sm text-gray-700 text-justify space-y-4 mb-6" x-html="formatIsi(detailData.isi_pengumuman)"></div>
