...
<head>
    ...
    <title>Manage Dokumen Informasi Setiap Saat</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900">
            <div class="bg-white dark:bg-gray-800 shadow-md pl-6 pr-6 py-5 mb-6 flex items-center">
                <h3 class="font-semibold text-gray-800 dark:text-white px-4">Manage Dokumen Informasi Setiap Saat</h3>
            </div>
            ...
            <form id="formUpdate" method="POST" action="{{ route('admin.ppid.save') }}" enctype="multipart/form-data" class="p-7">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                    ...
                    <h4 class="font-semibold text-gray-800 dark:text-white mb-3 text-center">Form Update Dokumen informasi Setiap Saat</h4>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="halamanSelect" class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" onchange="loadHalamanData(this.value)">
                            ...
                            <option value="Informasi Mengenai Daftar Informasi Publik">Informasi Mengenai Daftar Informasi Publik</option>
                            <option value="Informasi Mengenai Surat Perjanjian dengan Pihak Ketiga">Informasi Mengenai Surat Perjanjian dengan Pihak Ketiga</option>
                            <option value="Pedoman Pelayanan Publik">Pedoman Pelayanan Publik</option>
                            <option value="Jumlah, Jenis, Gambaran Umum Pengaduan">Jumlah, Jenis, Gambaran Umum Pengaduan</option>
                            <option value="Laporan Pelayanan Informasi">Laporan Pelayanan Informasi</option>
                            <option value="Laporan Data Aset">Laporan Data Aset</option>
