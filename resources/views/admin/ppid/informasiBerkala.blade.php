    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900">
            <div class="bg-white dark:bg-gray-800 shadow-md pl-6 pr-6 py-5 mb-6 flex items-center">
                <h3 class="font-semibold text-gray-800 dark:text-white px-4">Manage Dokumen Informasi Berkala</h3>
            </div>
            ...
            <form id="formUpdate" method="POST" action="{{ route('admin.ppid.save') }}" enctype="multipart/form-data" class="p-7">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                    ...
                    <h4 class="font-semibold text-gray-800 dark:text-white mb-3 text-center">Form Update Dokumen Informasi Berkala</h4>

                    <div class="mb-4">
                        <label class="block mb-1 font-medium text-gray-700 dark:text-gray-300">Pilih Halaman</label>
                        <select id="halamanSelect"
                            class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            onchange="loadHalamanData(this.value)">
                            <option value="">-- Pilih Halaman --</option>
                            <optgroup label="Kegiatan dan Kinerja">
                            ...
                            <optgroup label="Keuangan DISKOMINFO">
                                <option value="Laporan Keuangan berupa Rencana dan Laporan Realisasi Anggaran">
                                    Laporan Keuangan berupa Rencana dan Laporan Realisasi Anggaran
                                </option>
                                <option value="Laporan Keuangan berupa Laporan Arus Kas dan Catatan atas Laporan Keuangan">
                                    Laporan Keuangan berupa Laporan Arus Kas dan Catatan atas Laporan Keuangan
                                </option>
                                <option value="Laporan Keuangan berupa Daftar Aset dan Informasi">
                                    Laporan Keuangan berupa Daftar Aset dan Informasi
                                </option>
                                <option value="Informasi Rencana Kerja dan Anggaran">Informasi Rencana Kerja dan Anggaran</option>
                            </optgroup>

                            <optgroup label="Investasi">
                                <option value="Realisasi Investasi">Realisasi Investasi</option>
                            </optgroup>

                            <optgroup label="Laporan Akses Informasi Publik">
                                <option value="Register Keberatan Informasi">Register Keberatan Informasi</option>
                                <option value="Register Permohonan Informasi">Register Permohonan Informasi</option>
                                <option value="Jumlah Permohonan Informasi">Jumlah Permohonan Informasi</option>
                            </optgroup>

                            <optgroup label="Tata Cara Permohonan Informasi Publik">
                                <option value="SOP Pelayanan Informasi Publik">SOP Pelayanan Informasi Publik</option>
                                <option value="Permohonan Informasi Publik">Permohonan Informasi Publik</option>
                                <option value="Formulir Keberatan Informasi Publik">Formulir Keberatan Informasi Publik</option>
                            </optgroup>

                            <optgroup label="Lainnya">
                                <option value="Informasi Tata Cara Permohonan dan Pengaduan">Informasi Tata Cara Permohonan dan Pengaduan</option>
                                <option value="Rencana Strategis dan Rencana Kerja">Rencana Strategis dan Rencana Kerja</option>
                                <option value="Regulasi DISKOMINFO">Regulasi DISKOMINFO</option>
                                <option value="Daftar Informasi Publik">Daftar Informasi Publik</option>
                                <option value="Daftar Pejabat PPID">Daftar Pejabat PPID</option>
                            </optgroup>
                        </select>
