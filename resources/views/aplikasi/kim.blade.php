...
<body class="min-h-screen flex flex-col">
    <x-navbar />
    <header class="position-relative" style="height: 250px; background: url('/pictures/aplikasi/kim.jpg') center center / cover no-repeat;">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-area-layanan">
                ...
                <div class="icon-list-layanan">
                    <p><i class="fas fa-users"></i><strong>{{ $aplikasi->subheading1 }}</strong></p>
                    <p>{{ $aplikasi->text1 }}</p>

                    <p><i class="fas fa-bullhorn"></i><strong>{{ $aplikasi->subheading2 }}</strong></p>
                    <p>{{ $aplikasi->text2 }}</p>

                    <p><i class="fas fa-book-open"></i><strong>{{ $aplikasi->subheading3 }}</strong></p>
                    <p>{{ $aplikasi->text3 }}</p>
                </div>
            </div>
        </div>
