...
<body class="min-h-screen flex flex-col">
    <x-navbar />
    <header class="position-relative" style="height: 250px; background: url('/pictures/aplikasi/opd.jpg') bottom center / cover no-repeat;">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="pictures-layanan">
                    <a href="{{ $aplikasi->link }}" target="_blank" class="img-wrapper">
                        <img src="{{ asset($aplikasi->foto) }}" alt="PMO Kota Bandung" class="img-hover-effect" />
            ...
            <div class="col-lg-6 text-area-layanan">
                ...
                <div class="icon-list-layanan">
                    <p><i class="fas fa-network-wired"></i><strong>{{ $aplikasi->subheading1 }}</strong></p>
                    <p>{{ $aplikasi->text1 }}</p>

                    <p><i class="fas fa-tasks"></i><strong>{{ $aplikasi->subheading2 }}</strong></p>
                    <p>{{ $aplikasi->text2 }}</p>

                    <p><i class="fas fa-tools"></i><strong>{{ $aplikasi->subheading3 }}</strong></p>
                    <p>{{ $aplikasi->text3 }}</p>
                </div>
            </div>
        </div>
